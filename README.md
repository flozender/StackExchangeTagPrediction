...
We will be using two main pre-processing techniques - TFIDF and Word2Vec to build our input features, which will then be used with supervised classification algorithms such as Decision Trees. Another type of algorithm we hope to implement is Long-Short Term Memory (LSTM) neural networks.
